...
![](https://i-blog.csdnimg.cn/blog_migrate/10c01d2378fbf600d8593cee306c1080.png)

![](https://i-blog.csdnimg.cn/blog_migrate/298337182664e257220386bb2e319c12.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/addc1ee304924a5bdee264405ec56e8c.png)

![](https://i-blog.csdnimg.cn/blog_migrate/a8ed2e53b2d63ae04edd4b16b94ee954.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/f174406c46292de1f4d30b8682948980.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/0416989100c4f7a96c92e57d55fc7847.png)

**CopyOnWriteArrayList**使用的是Lock锁，效率会更加高效！

![](https://i-blog.csdnimg.cn/blog_migrate/e0f9043074bdd316f04392ef6f7695a9.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ec4dd386dc4c13efa5744e1c7eeb1caa.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/9e8d6c23617731b1d38f2d9abc3ac226.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/b59814a8141f0b1ffc2ec249647afae3.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ce8087d0b38209517e3b2ba36c798d29.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/82aa2f3cb2a37409f817d8e8dad94459.png)

![](https://i-blog.csdnimg.cn/blog_migrate/c8320f088a84611df736f8d9731b3a0c.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/1752930ed6d3e27f9e7185f9dba1487e.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/942cca6a0ef21326a30ac95a7f872ca9.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/1c0d9b48a37cfd2fd06261ca15c37f60.png)

![](https://i-blog.csdnimg.cn/blog_migrate/65eb336c105791f0a7a17bb7b2d7a07f.png)

#### 1）Function 函数型接口

![](https://i-blog.csdnimg.cn/blog_migrate/fde53f33a9e4909aaf6b129ccab5846a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e658ace0f5d5e3913dbac600e607819c.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c663f32a07a8f0dde688adb3f8850abc.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c5641402010af463e285685614c2a92a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/db9aed609e9af529d5ee9329d1abb042.png)

#### 1）ForkJoin 特点： 工作窃取！

实现原理是：**双端队列**！从上面和下面都可以去拿到任务进行执行！

![](https://i-blog.csdnimg.cn/blog_migrate/7a598d51e33ab37e96a51cac93252dd7.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/41c9d932202cd400c14d4c4cffdcd213.png)

**.parallel().reduce(0, Long::sum)使用一个并行流去计算整个计算，提高效率。**

![](https://i-blog.csdnimg.cn/blog_migrate/d6462fdfcd3f129313cd823a75f09ceb.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e1341d08ca9cedca499ece9827a68e80.png)
...
*   **unlock（解锁）**：作用于主内存的变量，它把一个处于锁定状态的变量释放出来，释放后的变量才可以被其他线程锁定；
    ...
    ![](https://i-blog.csdnimg.cn/blog_migrate/917669b5ae7ad5e14d69f2313da28dd5.png)
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/12f62bb1227e5b924d845d4c79711972.png)
    ...
    *   对一个变量进行unlock操作之前，必须把此变量同步回主内存
    ...
    ![](https://i-blog.csdnimg.cn/blog_migrate/30845b75bc0ac76e105ef2b1700cd494.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/91cbec5068448ebec5a35317624f2d42.png)

**使用原子类**

![](https://i-blog.csdnimg.cn/blog_migrate/39fcc2df4192f58bf399e900a5628558.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ee0dbf2b7b4a33175b15601fc4f4e726.png)
...
public class Hungry {
    ...
    private byte[] data4=new byte1024*1024];
    private Hungry(){   
    }
...
![](https://i-blog.csdnimg.cn/blog_migrate/584b9cf3447525d6265facb0ba441e9b.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/cd5c1fc6fe4cd04a1864b2d4eddee19b.png)

![](https://i-blog.csdnimg.cn/blog_migrate/f3de334d8d1f554b36615566fa2cfda9.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/367daf81c6954d227b5ac98222a296e6.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/44ce2da82b71f9c514c38e51e5afeba9.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/96c04760e13e393233639ce126b09b9a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/a888c6e5944c54d7ff77e867e68a6417.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/7bee08d3b5ace01c24286b19465c9ce3.png)

**2、使用`jstack` 进程进程号 找到死锁信息**

![](https://i-blog.csdnimg.cn/blog_migrate/2e1df30c553f3c9fb255feec7ec46247.png)

**一般情况信息在最后：**

![](https://i-blog.csdnimg.cn/blog_migrate/fa64cab8ddb7fa7c9f426dd9401580ce.png)
...
##### 1.1按照锁的特性划分 `悲观锁`和`乐观锁`

`悲观锁`总是假设最坏的情况，认为共享资源每次被访问的时候就会出现问题(比如共享数据被修改)，所以每次在获取资源操作的时候都会上锁，这样其他线程想拿到这个资源就会阻塞直到锁被上一个持有者释放。也就是说，**共享资源每次只给一个线程使用，其它线程阻塞，用完后再把资源转让给其它线程**。例如synchronized

`乐观锁`每次不是加锁，而是假设没有冲突而**去试探性的完成操作**，如果因为冲突失败了就重试，直到成功。比如**版本号机制**和**CAS 算法**。

##### 1.2按照锁的顺序划分`公平锁`和`非公平锁`

`公平锁` : 锁被释放之后，先申请的线程先得到锁。性能较差一些，因为公平锁为了保证时间上的绝对顺序，上下文切换更频繁。

`非公平锁`：锁被释放之后，后申请的线程可能会先获取到锁，是随机或者按照其他优先级排序的。性能更好，但可能会导致某些线程永远无法获取到锁。

##### 1.3按照访问控制方式划分 `排他锁/独占锁`和`共享锁`

`独占锁`：一把锁只能被一个线程获得。	

`共享锁`：一把锁可以被多个线程同时获得。

##### 1.4实现方式划分:Java中的锁分为两种`隐式锁` 和`显式锁` 

1. `synchronized` 同步关键字 ,属于隐式锁,是jvm层面实现,运行时看不见
2. `Lock`接口以及对应的实现类,在java.util.concurrent.locks包下,我们在代码层面可以看见这个锁对象,而这些对象大都是依赖CPU指令,无关jvm的实现



##### 1.5 CAS 

`CAS` 全称叫 `CompareAndSwap` 比较并交换 是一种乐观锁机制，依赖于底层 CPU 提供的原子指令。它通过比较内存值与期望值是否相同来决定是否更新内存，从而实现线程安全的并发操作而无需加锁。

在 Java 中，CAS 通过 `Unsafe` 类中的 `native` 方法实现，这些方法调用底层的硬件指令来完成原子操作。由于其实现依赖于 C++ 内联汇编和 JNI 调用，因此 CAS 的具体实现与操作系统以及 CPU 密切相关。CAS 虽然具有高效的无锁特性，但也需要注意 ABA 、循环时间长开销大等问题。

 CAS 的三大问题

1. **ABA 问题**
    值从 A → B → A，CAS 误以为值未变。解决方案：使用版本号（如 `AtomicStampedReference`）。
2. **自旋浪费 CPU**
    如果一直更新失败，会无限循环尝试，占用 CPU。
3. **只能更新一个变量**
    无法一次性比较并更新多个字段，需用 `AtomicReference` 封装对象或使用 `VarHandle`。
...
AQS 是一个用来构建锁和同步器（如 ReentrantLock、Semaphore）的抽象框架，基于 FIFO 队列管理线程等待，实现高效的阻塞/唤醒机制。
